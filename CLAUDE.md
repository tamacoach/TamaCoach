...
TamaCoach is an Obsidian vault. Obsidian is a markdown-based knowledge management and note-taking application.

## Repository Status

This is a newly initialized vault with no existing content beyond the default welcome note.
...
- Frontmatter (YAML) can be added at the top of notes for metadata

## Language

Primary language for content is Korean.
